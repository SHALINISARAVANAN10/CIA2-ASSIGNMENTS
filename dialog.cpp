...
{
     QMessageBox::information(this,"shalini s 212218205048", "This is QMessageBox");
}

void Dialog::on_pushButton_2_clicked()
{
    QMessageBox::StandardButton reply = QMessageBox::question(this,
                                       "shalini 212218205048", "Do You like strawberry?",
...
{
    QMessageBox::StandardButton reply = QMessageBox::question(this,
                                       "shalini s 212218205048", "This is Custom message",
        ...
        {
            QMessageBox::warning(this,"shalini s 212218205048","Display the message with warning as YesToAll");
        }
        if(reply == QMessageBox::NoToAll)
        {
            QMessageBox::warning(this,"shalin s 212218205048","Don't display the message with warning as YesToAll");
        }
        if(reply == QMessageBox::No) {
...
{
    QMessageBox::warning(this,"shalini s 212218205048", "this is warning message");
